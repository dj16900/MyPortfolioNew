...
>(({ className, children, onFullScreenChange, ...props }, ref) => {
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          isFullScreen && "h-screen w-screen max-w-none max-h-none rounded-none left-0 top-0 translate-x-0 translate-y-0 p-8 inset-0",
          className
        )}
        {...props}
      >
